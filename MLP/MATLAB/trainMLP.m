...
switch opts.configure
    ...
    case 'python'
        ...
        % Edit model folder
        opts.ModelFolder = [opts.ModelFolder '/Python'];
    ...
    case 'MATLAB'
        ...
        outputfolder = [opts.ModelFolder '/' modeltype '/' schemename '/' opts.noisetype '/T2_' num2str(opts.T2train) '/sigma_' num2str(opts.sigma0train)];
        mkdir(outputfolder);
